...
function boss(startx, starty, sprite, lvl, hp)
  ...
  b.size, b.bullet_speed, b.fire_rate, b.destroyed_step, b.destroy_anim_length, b.health, b.full_health = 16, 2, 5, 0, 30, (hp or 50), (hp or 50)
  b.sang = 0
  ...
  b.update = function()
           ...
           if b.level == 1 then
             ...
             for i=1,360,90 do
               if (b.b_count%b.fire_rate == 0) shoot(b.x, b.y, i+(rev*b.angle)+rnd(10), 141, false, true)
             end
           ...
           elseif b.level == 3 then
             if #enemy_spawned > 0 or #enemy_table > 0 then
              ...
              if (b.b_count%(b.fire_rate+15)==0) for i=0,360,180 do shoot(b.x, b.y, i+b.angle, 76, false, true, false, true) end
            end
...

